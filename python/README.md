...
Leading `*.` excludes the apex domain. Paths are case sensitive, retain percent encoding, exclude queries,
...
unmatched traffic does not delay draining. The drain waits up to ten minutes by default,
