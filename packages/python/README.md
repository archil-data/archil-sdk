...
```python
from archil_control import Client
...
```python
from archil_control import AuthenticatedClient
...
```python
from archil_control.models import MyDataModel
from archil_control.api.my_tag import get_my_data_model
from archil_control.types import Response
...
1. Any endpoint which did not have a tag will be in `archil_control.api.default`
