...
```python
from archil import AuthenticatedClient
...
```python
from archil.models import MyDataModel
from archil.api.my_tag import get_my_data_model
from archil.types import Response
...
1. Any endpoint which did not have a tag will be in `archil.api.default`
